...
-- Dumping data for table svara.board_cards: ~16 rows (approximately)
...
INSERT INTO `board_cards` (`id`, `created_at`, `updated_at`, `name`, `description`, `column_id`, `assigned_user_id`, `label_id`, `created_by_id`) VALUES
	...
	(6, '2021-03-30 21:31:04', '2021-03-30 21:31:04', 'Another Card', NULL, 1, NULL, NULL, NULL),
	(7, '2021-03-30 21:45:02', '2021-03-30 21:45:02', 'A Piece of Work', NULL, 2, NULL, NULL, NULL),
	(8, '2021-03-30 21:47:35', '2021-03-30 21:47:35', 'Another piece of work', NULL, 2, NULL, NULL, NULL),
	(9, '2021-03-30 21:48:08', '2021-03-30 21:48:08', 'Work 4', NULL, 2, NULL, NULL, NULL),
	(10, '2021-04-04 13:28:50', '2021-04-04 13:28:50', 'Something to test', NULL, 3, 1, NULL, NULL),
	(11, '2021-04-04 13:28:57', '2021-04-04 13:28:57', 'Something in progress', NULL, 2, 1, NULL, NULL),
	(12, '2021-04-04 13:42:21', '2021-04-04 13:42:21', 'In Progress Task', NULL, 2, 1, NULL, NULL),
	(13, '2021-04-04 13:44:44', '2021-04-04 13:44:44', 'New Card', NULL, 2, 1, NULL, NULL),
	...
	(16, '2021-04-05 21:33:02', '2021-04-05 21:33:02', 'A card added by someone else', NULL, 2, 1, NULL, 2);
/*!40000 ALTER TABLE `board_cards` ENABLE KEYS */;

-- Dumping structure for table svara.board_card_attachments
DROP TABLE IF EXISTS `board_card_attachments`;
...
DROP TABLE IF EXISTS `board_card_messages`;
...
-- Dumping data for table svara.board_columns: ~3 rows (approximately)
...
-- Dumping data for table svara.clients: ~3 rows (approximately)
DELETE FROM `clients`;
...
INSERT INTO `clients` (`id`, `name`, `logo_path`, `contact_number`, `contact_email`, `main_contact_id`, `account_manager_id`) VALUES
	...
	(3, 'Aviato', 'storage/avatars/aviato-logo.png', '01234 567890', 'erlich@aviato.com', 5, 4);
...
DROP TABLE IF EXISTS `message_thread_attachments`;
...
DROP TABLE IF EXISTS `message_thread_messages`;
...
-- Dumping data for table svara.message_thread_messages: ~7 rows (approximately)
...
-- Dumping data for table svara.migrations: ~26 rows (approximately)
...
DROP TABLE IF EXISTS `pipeline_entities`;
...
-- Dumping data for table svara.projects: ~4 rows (approximately)
...
INSERT INTO `projects` (`id`, `created_at`, `updated_at`, `client_id`, `name`, `project_lead_id`, `project_state_id`, `current_phase_id`) VALUES
	(21, '2021-03-22 20:14:15', '2021-03-22 20:14:18', 1, 'Example Project', NULL, 5, 22),
	(22, '2021-03-25 09:13:44', '2021-04-06 16:18:17', 1, 'Example Project', NULL, 5, 25),
	(23, '2021-04-09 21:12:50', '2021-04-09 21:12:50', 2, 'The new project', NULL, 11, NULL),
	(24, '2021-04-10 21:40:44', '2021-04-10 21:40:44', 1, 'Example Project', NULL, 1, NULL);
/*!40000 ALTER TABLE `projects` ENABLE KEYS */;

-- Dumping structure for table svara.project_metas
DROP TABLE IF EXISTS `project_metas`;
...
DROP TABLE IF EXISTS `project_meta_options`;
...
DROP TABLE IF EXISTS `project_pipelines_to_entities`;
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `job_role`, `type_id`, `remember_token`, `created_at`, `updated_at`, `activated`, `deactivated`) VALUES
	...
	(15, 'Dr. Jonathon Deckow I', 'marley.hartmann@example.org', '2021-03-22 19:33:47', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, 0, 'Yhe9DNstoX', '2021-03-22 19:33:48', '2021-03-22 19:33:48', '2021-04-11 12:34:20', NULL),
	(16, 'Test User', 'test@charlesbjerg.com', NULL, '$2y$10$h3dx/bRRf8lvlss7amjnOu5kZE6G9JXQM7daJorhqPgigULlQ/uXK', NULL, 1, NULL, '2021-04-11 11:32:18', '2021-04-11 11:32:18', NULL, NULL);
...
-- Dumping data for table svara.users_to_projects: ~17 rows (approximately)
...
DROP TABLE IF EXISTS `users_to_teams`;
