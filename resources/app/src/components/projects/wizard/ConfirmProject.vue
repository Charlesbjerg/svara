<template>
    <section class="pw-data">
        ...
        <section class="confirm-section">
            ...
            <pipeline-phase-card v-for="(section, index) in project.pipeline" :key="index" :section="section" :index="index" />
        </section>

        <!-- TODO: Click confirm button to create project -->
        <footer class="confirm-footer">
            <p>On creation all project staff, including the client, will be notified that the project has been created. </p>
